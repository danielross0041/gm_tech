...
Route::get('/', [IndexController::class, 'problem'])->name('problem');
Route::get('/login', [IndexController::class, 'login'])->name('login');

Route::post('/submit_problem', [IndexController::class, 'submit_problem'])->name('submit_problem');
...
Route::group(['middleware' => 'auth'], function()
{
    ...
    Route::get('/entry/{id}', [HomeController::class, 'entry'])->name('entry');
    Route::post('/part_submit', [HomeController::class, 'part_submit'])->name('part_submit');
